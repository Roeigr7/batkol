...
export function ThemeToggle() {
  ...
  return (
    <div ref={menuRef} className="fixed bottom-[128px] left-4 md:bottom-[168px] md:left-6 z-50">
      {/* Theme Menu */}
      {isOpen && (
        <div
          className="absolute bottom-12 md:bottom-16 left-0 w-36 md:w-40 rounded-xl shadow-2xl overflow-hidden border theme-toggle-menu"
          role="menu"
      ...
      <button
        ...
        className={`w-10 h-10 md:w-14 md:h-14 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all cursor-pointer group theme-toggle-button ${
